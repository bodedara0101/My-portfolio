    ...
    <nav className="px-4 text-white fixed w-full top-0 z-10 h-16 backdrop-blur-lg backdrop-opacity-35 bg-blue-600 bg-opacity-75 flex items-center">
      <div className="flex justify-between items-center w-full">
        ...
        >
          ...
          </svg>:<svg height="25" id="Layer_1" version="1.1" fill="white" viewBox="0 0 512 512" width="25" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><path d="M437.5,386.6L306.9,256l130.6-130.6c14.1-14.1,14.1-36.8,0-50.9c-14.1-14.1-36.8-14.1-50.9,0L256,205.1L125.4,74.5  c-14.1-14.1-36.8-14.1-50.9,0c-14.1,14.1-14.1,36.8,0,50.9L205.1,256L74.5,386.6c-14.1,14.1-14.1,36.8,0,50.9  c14.1,14.1,36.8,14.1,50.9,0L256,306.9l130.6,130.6c14.1,14.1,36.8,14.1,50.9,0C451.5,423.4,451.5,400.6,437.5,386.6z"/></svg>}
        </div>
      </div>
    </nav>
  );
